...
$string['messageprovider:pagamentoseguro_enrolment'] = 'PagSeguro enrolment messages';
$string['needsignuporlogin'] = 'You need to sign up or log in before make a payment.';
$string['nocost'] = 'There is no cost associated with enrolling in this course!';
$string['pagamentoseguro:config'] = 'Configure PagSeguro enrol instances';
...
$string['pagamentoseguroaccepted'] = 'PagSeguro payments accepted';
