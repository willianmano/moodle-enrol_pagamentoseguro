...
class enrol_pagamentoseguro_enrol_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'pagamentoseguroheader', $heading);
        ...
        $mform->addElement('static', 'paymentrequired', '', get_string('paymentrequired', 'enrol_pagamentoseguro', $instance));

        $pagamentoseguroimgurl = "https://p.simg.uol.com.br/out/pagamentoseguro/i/botoes/pagamentos/99x61-pagar-assina.gif";
        $mform->addElement('static', 'paymentrequired', '',
                           html_writer::empty_tag('img', array('alt' => get_string('pagamentoseguroaccepted', 'enrol_pagamentoseguro'),
                                                               'src' => $pagamentoseguroimgurl)));
        ...
        $this->add_action_buttons(false, get_string('sendpaymentbutton', 'enrol_pagamentoseguro'), '1');
    }
}
